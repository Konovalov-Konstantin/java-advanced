...
public class Example {
    ...
    public static void syncGet(String uri) throws Exception {
        /** HttpClient - шаблон для отправки запросов и получения ответов */
        HttpClient client = HttpClient.newHttpClient();

        /** HttpRequest - шаблон для создания Http-запроса с помощью построителя HttpRequest.newBuilder */
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create(uri))
                .build();

        /** HttpResponse возвращается в результате отправки HttpRequest */
